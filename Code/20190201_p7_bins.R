...
###RUNNING SCENIC:
##create directory 
dir.create("/data/kollal2/scenic/20190201_p7_bins")
setwd("/data/kollal2/scenic/20190201_p7_bins")
dir.create("int")
...
myDatasetTitle="Pooled P7 scenic" # choose a name for your analysis
