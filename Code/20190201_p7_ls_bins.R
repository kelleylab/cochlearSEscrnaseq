...
P7 <- readRDS("/data/kollal2/scenic/p7_epi_final.Rds")
P7 <- SetIdent(P7, cells.use = WhichCells(P7, ident = c("Lateral_GER_1", "Lateral_GER_2", "Lateral_GER_3", "Lateral_GER_4")),
                  ident.use = "Lateral_GER")

P7 <- SetIdent(P7, cells.use = WhichCells(P7, ident = c("Medial_GER_1", "Medial_GER_2")),
                  ident.use = "Medial_GER")

P7 <- SetIdent(P7, cells.use = WhichCells(P7, ident = c("Medial_Lateral_GER_1", "Medial_Lateral_GER_2")),
                  ident.use = "Medial_Lateral_GER")
...
###RUNNING SCENIC:
##create directory 
dir.create("/data/kollal2/scenic/20190201_p7_ls_bins")
setwd("/data/kollal2/scenic/20190201_p7_ls_bins")
dir.create("int")
...
myDatasetTitle="Pooled P7 LS scenic" # choose a name for your analysis
...
scenicOptions <- readRDS("int/scenicOptions.Rds")
cellInfo <- readRDS("int/cellInfo.Rds")[,1]
